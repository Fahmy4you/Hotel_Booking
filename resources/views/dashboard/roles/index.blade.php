...
@section('container')
    ...
    <div class="flex justify-between items-center mb-4 mt-5">
      ...
      <a href="{{ route('roles.create') }}" class="hidden bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300">
        Create Data
      </a>
    </div>
      ...
      <table class="w-full border border-gray-300 text-left">
        <thead class="bg-gray-200">
          <tr>
            ...
            <th class="px-4 py-2 border-b border-gray-300 text-center hidden">Actions</th>
          </tr>
        </thead>
        <tbody>
